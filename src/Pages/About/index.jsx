...
function About() {
    return(
        <Container>
            ...
            <p>Hoje, a Pioneira continua a crescer, sempre guiada pelos valores que nos trouxeram até aqui: inovação, sustentabilidade e excelência. Nossa equipe trabalha diariamente para oferecer soluções que impulsionam o futuro do agronegócio, ajudando agricultores a alcançar o sucesso e a produzir com responsabilidade.</p>

...
function About() {
    return(
        <Container>
            <h2 className="titulo-h2">Nossa História</h2>
            ...
            <Accordion defaultActiveKey="0">
                ...
                <Accordion.Item eventKey="2">
                    ...
                    <strong>Compromisso com o Cliente:</strong> Nossa prioridade é oferecer soluções que agreguem valor ao negócio dos nossos clientes, ajudando-os a alcançar o sucesso em suas atividades agrícolas.
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
            <h3 className="sub-titulo-h3 " >Sustentabilidade</h3>
            <p>A sustentabilidade sempre foi uma das nossas principais preocupações. Desde o início, buscamos desenvolver soluções que minimizem o impacto ambiental e promovam o uso responsável dos recursos naturais.</p>
            <p>Acreditamos que o futuro da agricultura depende de práticas sustentáveis, e trabalhamos constantemente para inovar nesse sentido. Um dos nossos marcos importantes foi o lançamento de sementes adaptadas a diferentes condições climáticas e resistentes a pragas, ajudando os agricultores a produzir mais com menos recursos, mantendo o foco na preservação do solo e da biodiversidade.</p>
